...
try{
 ...
 const plans=JSON.parse(await readFile(new URL('./printful-batch4-plans.json',import.meta.url),'utf8'));check(plans.length===3&&plans.every(p=>[692,1635,636].includes(p.catalogId)),'plans_refused');
