...
export async function run({env=process.env,fetchImpl=fetch,delay=ms=>new Promise(r=>setTimeout(r,ms))}={}){
  ...
  const plans=[{key:'signature-white-tee',shopifyId:'8641656848418',source:'https://cdn.shopify.com/s/files/1/0861/2079/2098/files/cnd-signature-white-tee-production-front-161dpi.png?v=1789142837',color:'Black',variantId:4017,position:{area_width:1800,area_height:2400,width:1800,height:2400,top:0,left:0}}];
  const report={status:'complete',storeVerified:true,productWrites:0,proofs:[],signatureSourceAvailable:true};
